...
function custom_theme_css_global() {
    ...
    wp_enqueue_style( "custom_theme_css_global", get_template_directory_uri()."/assets/css/styles.css", array(), $theme_version );
}
...
function custom_theme_css_by_page_type() {
    ...
    if ( is_front_page() || is_page('front-page') ) {
        wp_enqueue_style( "custom-page-front", get_template_directory_uri()."/assets/css/front.css", array(), $theme_version );
    }
}
